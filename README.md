...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/auto-comment
```

A live public deployment of this template is available at [https://auto-comment.templates.workers.dev](https://auto-comment.templates.workers.dev)
